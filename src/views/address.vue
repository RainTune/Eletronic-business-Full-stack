<template>
  <div>
      ...
      <div class="container">
        <div class="checkout-addr">
          ...
          <div class="addr-list-wrap">
            <div class="addr-list">
              <ul>
                <li v-for="(item,index) in addressListFilter" @click="setDefault(item.addressId, index)" :class="{'check': item.isDefault}">
                  <dl>
                    <dt>{{item.userName}}</dt>
                  ...
                  <div class="addr-opration addr-del">
                    <a href="javascript:;" class="addr-del-btn" @click.stop="delComfirm(item.addressId, index)">
                ...
                <li class="addr-new" @click = "showAddressModal = true">
            ...
            <div class="shipping-addr-more">
              <a class="addr-more-btn up-down-btn" href="javascript:;" @click="expand" :class="{'open': limit>2}">
                more
                <i class="i-up-down">
          ...
          <div class="next-btn-wrap">
            <a class="btn btn-primary" @click="goOrder" style="color: white;">Next</a>
          </div>
        </div>
      </div>
    </div>
    <modal v-show="showModal" @close="closeModal">
      ...
      <div slot="btnGroup">
        <a href="javascript:;" class="btn btn-danger" @click="Del">删除</a>
        <a href="javascript:;" class="btn btn-warning" @click="closeModal">关闭</a>
      </div>
    </modal>
    <address-modal v-show="showAddressModal" @close="closeModal" @callBackFromModal="callBackFromModal"></address-modal>
...
<script>
  ...
  export default {
    ...
    watch: {
      addressList: function (cur, old) {
        if(cur.length == 1) {
          this.setDefault(this.addressList[0].addressId,0);
